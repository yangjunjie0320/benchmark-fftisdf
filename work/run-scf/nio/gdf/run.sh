...
#SBATCH --job-name=run-scf/nio/gdf/
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-scf.py /central/home/junjiey/work/benchmark-fftisdf/work/run-scf/nio/gdf//main.py
python main.py --name=nio --ke_cutoff=100.0 --exxdiv=None --mesh=1,1,1 --df=gdf
