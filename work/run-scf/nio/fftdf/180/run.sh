...
#SBATCH --job-name=run-scf/nio/fftdf/180
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-scf.py /central/home/junjiey/work/benchmark-fftisdf/work/run-scf/nio/fftdf/180/main.py
python main.py --name=nio --ke_cutoff=180.0 --exxdiv=None --mesh=1,1,1 --df=fftdf --chk_path=/central/scratch/yangjunjie/run-scf/nio/gdf/47941658/scf.h5
