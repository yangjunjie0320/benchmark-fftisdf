...
#SBATCH --job-name=run-scf/diamond/fftdf/100
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-scf.py /central/home/junjiey/work/benchmark-fftisdf/work/run-scf/diamond/fftdf/100/main.py
python main.py --name=diamond --ke_cutoff=110.0 --exxdiv=None --mesh=1,1,1 --df=fftdf --chk_path=/central/scratch/yangjunjie/run-scf/diamond/gdf/47941657/scf.h5
