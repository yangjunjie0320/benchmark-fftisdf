...
#SBATCH --job-name=run-uks-kpt-nio-afm-4-4-4-gdf-64-
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-uks-kpt.py /central/home/junjiey/work/benchmark-fftisdf/work/run-uks-kpt/nio-afm/4-4-4/gdf-64//main.py
python main.py --name=nio-afm --ke_cutoff=None --exxdiv=None --df=gdf --chk_path=None --mesh=4,4,4
