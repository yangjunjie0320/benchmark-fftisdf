...
#SBATCH --job-name=run-uks-kpt-nio-afm-1-2-2-gdf-32-k0-40.0-c0-30.0
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-uks-kpt.py /central/home/junjiey/work/benchmark-fftisdf/work/run-uks-kpt/nio-afm/1-2-2/gdf-32/k0-40.0-c0-30.0/main.py
python main.py --name=nio-afm --df=gdf --ke_cutoff=None --exxdiv=None --chk_path=../../../gdf-32/tmp/scf.h5 --mesh=1,2,2 --k0=40.0 --c0=30.0
