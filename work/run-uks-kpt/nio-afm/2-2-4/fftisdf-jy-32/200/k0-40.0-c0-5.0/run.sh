...
#SBATCH --job-name=run-uks-kpt-nio-afm-2-2-4-fftisdf-jy-32-200-k0-40.0-c0-5.0
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-uks-kpt.py /central/home/junjiey/work/benchmark-fftisdf/work/run-uks-kpt/nio-afm/2-2-4/fftisdf-jy-32/200/k0-40.0-c0-5.0/main.py
python main.py --name=nio-afm --df=fftisdf-jy --ke_cutoff=200.0 --exxdiv=None --chk_path=../../../gdf-32/tmp/scf.h5 --mesh=2,2,4 --k0=40.0 --c0=5.0
