...
#SBATCH --job-name=run-uks-kpt-nio-conv-1-1-2-gdf-1-k0-60.0-c0-5.0
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-uks-kpt.py /central/home/junjiey/work/benchmark-fftisdf/work/run-uks-kpt/nio-conv/1-1-2/gdf-1/k0-60.0-c0-5.0/main.py
