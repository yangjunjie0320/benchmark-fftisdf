...
#SBATCH --job-name=run-uks-kpt-nio-conv-2-2-4-gdf-64-200-
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-uks-kpt.py /central/home/junjiey/work/benchmark-fftisdf/work/run-uks-kpt/nio-conv/2-2-4/gdf-64/200//main.py
python main.py --name=nio-conv --ke_cutoff=None --df=gdf --exxdiv=None --chk_path=None --mesh=2,2,4
