...
#SBATCH --job-name=run-uks-kpt-nio-conv-1-1-1-gdf-32-k0-80.0-c0-15.0
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-uks-kpt.py /central/home/junjiey/work/benchmark-fftisdf/work/run-uks-kpt/nio-conv/1-1-1/gdf-32/k0-80.0-c0-15.0/main.py
python main.py --name=nio-conv --df=gdf --ke_cutoff=None --exxdiv=None --chk_path=../../../gdf-32/tmp/scf.h5 --mesh=1,1,1 --k0=80.0 --c0=15.0
