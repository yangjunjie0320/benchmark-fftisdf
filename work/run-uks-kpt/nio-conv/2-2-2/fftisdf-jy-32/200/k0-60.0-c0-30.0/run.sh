...
#SBATCH --job-name=run-uks-kpt-nio-conv-2-2-2-fftisdf-jy-32-200-k0-60.0-c0-30.0
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-uks-kpt.py /central/home/junjiey/work/benchmark-fftisdf/work/run-uks-kpt/nio-conv/2-2-2/fftisdf-jy-32/200/k0-60.0-c0-30.0/main.py
python main.py --name=nio-conv --df=fftisdf-jy --ke_cutoff=200.0 --exxdiv=None --chk_path=../../../gdf-32/tmp/scf.h5 --mesh=2,2,2 --k0=60.0 --c0=30.0
