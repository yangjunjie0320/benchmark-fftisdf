...
#SBATCH --job-name=run-scf-kpt-diamond-conv-1-2-2-gdf-32-k0-60.0-c0-10.0
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-scf-kpt.py /central/home/junjiey/work/benchmark-fftisdf/work/run-scf-kpt/diamond-conv/1-2-2/gdf-32/k0-60.0-c0-10.0/main.py
python main.py --name=diamond-conv --ke_cutoff=None --exxdiv=None --df=gdf --chk_path=None --mesh=1,2,2 --k0=60.0 --c0=10.0
