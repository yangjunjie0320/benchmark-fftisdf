...
#SBATCH --job-name=run-scf-kpt-diamond-conv-2-2-4-fftisdf-jy-32-100-k0-100.0-c0-10.0
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-scf-kpt.py /central/home/junjiey/work/benchmark-fftisdf/work/run-scf-kpt/diamond-conv/2-2-4/fftisdf-jy-32/100/k0-100.0-c0-10.0/main.py
python main.py --name=diamond-conv --ke_cutoff=100.0 --exxdiv=None --df=fftisdf-jy --chk_path=None --mesh=2,2,4 --k0=100.0 --c0=10.0
