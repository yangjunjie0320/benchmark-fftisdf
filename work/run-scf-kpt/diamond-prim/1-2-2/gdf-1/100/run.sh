...
#SBATCH --job-name=run-scf-kpt-diamond-prim-1-2-2-gdf-1-100-
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-scf-kpt.py /central/home/junjiey/work/benchmark-fftisdf/work/run-scf-kpt/diamond-prim/1-2-2/gdf-1/100//main.py
