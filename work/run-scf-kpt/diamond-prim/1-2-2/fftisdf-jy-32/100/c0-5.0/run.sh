...
#SBATCH --job-name=run-scf-kpt-diamond-prim-1-2-2-fftisdf-jy-32-100-c0-5.0
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-scf-kpt.py /central/home/junjiey/work/benchmark-fftisdf/work/run-scf-kpt/diamond-prim/1-2-2/fftisdf-jy-32/100/c0-5.0/main.py
python main.py --name=diamond-prim --ke_cutoff=100.0 --exxdiv=None --df=fftisdf-jy --chk_path=None --mesh=1,2,2 --c0=5.0 --k0=None
