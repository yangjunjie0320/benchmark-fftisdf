...
#SBATCH --job-name=run-scf-kpt-diamond-prim-4-4-4-gdf-32-100-
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-scf-kpt.py /central/home/junjiey/work/benchmark-fftisdf/work/run-scf-kpt/diamond-prim/4-4-4/gdf-32/100//main.py
python main.py --name=diamond-prim --ke_cutoff=100.0 --exxdiv=None --df=gdf --chk_path=None --mesh=4,4,4
