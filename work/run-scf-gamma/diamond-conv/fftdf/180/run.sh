...
#SBATCH --job-name=run-scf-gamma/diamond-conv/fftdf/180
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-scf-gamma.py /central/home/junjiey/work/benchmark-fftisdf/work/run-scf-gamma/diamond-conv/fftdf/180/main.py
python main.py --name=diamond-conv --ke_cutoff=180.0 --exxdiv=None --df=fftdf --chk_path=/central/scratch/yangjunjie//run-scf-gamma/diamond-conv/gdf/47958841/scf.h5
