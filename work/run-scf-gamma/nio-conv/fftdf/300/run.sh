...
#SBATCH --job-name=run-scf-gamma/nio-conv/fftdf/300
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-scf-gamma.py /central/home/junjiey/work/benchmark-fftisdf/work/run-scf-gamma/nio-conv/fftdf/300/main.py
python main.py --name=nio-conv --ke_cutoff=300.0 --exxdiv=None --df=fftdf --chk_path=/central/scratch/yangjunjie//run-scf-gamma/nio-conv/gdf/47958839/scf.h5
