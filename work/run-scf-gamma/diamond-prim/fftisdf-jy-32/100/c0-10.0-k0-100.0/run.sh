#!/bin/bash
#SBATCH --exclude=hpc-21-34,hpc-34-34,hpc-52-29,hpc-20-16
#SBATCH --job-name=run-scf-gamma/diamond-prim/fftisdf-jy-32/100/c0-10.0-k0-100.0
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-scf-gamma.py /central/home/junjiey/work/benchmark-fftisdf/work/run-scf-gamma/diamond-prim/fftisdf-jy-32/100/c0-10.0-k0-100.0/main.py
kernprof -l main.py --name=diamond-prim --ke_cutoff=100.0 --exxdiv=None --df=fftisdf-jy --chk_path=/central/scratch/yangjunjie//run-scf-gamma/diamond-prim/gdf/47958842/scf.h5 --c0=10.0 --k0=100.0
