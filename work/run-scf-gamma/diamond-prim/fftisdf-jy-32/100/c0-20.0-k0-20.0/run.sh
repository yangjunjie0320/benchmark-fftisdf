...
#SBATCH --job-name=run-scf-gamma/diamond-prim/fftisdf-jy-32/100/c0-20.0-k0-20.0
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-scf-gamma.py /central/home/junjiey/work/benchmark-fftisdf/work/run-scf-gamma/diamond-prim/fftisdf-jy-32/100/c0-20.0-k0-20.0/main.py
python main.py --name=diamond-prim --ke_cutoff=100.0 --exxdiv=None --df=fftisdf-jy --chk_path=/central/scratch/yangjunjie//run-scf-gamma/diamond-prim/gdf/47958842/scf.h5 --c0=20.0 --k0=20.0
