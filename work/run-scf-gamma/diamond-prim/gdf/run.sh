...
#SBATCH --job-name=run-scf-gamma/diamond-prim/gdf
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-scf-gamma.py /central/home/junjiey/work/benchmark-fftisdf/work/run-scf-gamma/diamond-prim/gdf/main.py
python main.py --name=diamond-prim --ke_cutoff=None --exxdiv=None --df=gdf --chk_path=None
