...
#SBATCH --job-name=run-scf-gamma/diamond-prim/fftdf/80
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-scf-gamma.py /central/home/junjiey/work/benchmark-fftisdf/work/run-scf-gamma/diamond-prim/fftdf/80/main.py
python main.py --name=diamond-prim --ke_cutoff=80.0 --exxdiv=None --df=fftdf --chk_path=/central/scratch/yangjunjie//run-scf-gamma/diamond-prim/gdf/47958842/scf.h5
