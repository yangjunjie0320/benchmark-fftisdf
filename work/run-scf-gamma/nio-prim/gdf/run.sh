...
#SBATCH --job-name=run-scf-gamma/nio-prim/gdf
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-scf-gamma.py /central/home/junjiey/work/benchmark-fftisdf/work/run-scf-gamma/nio-prim/gdf/main.py
python main.py --name=nio-prim --ke_cutoff=None --exxdiv=None --df=gdf --chk_path=None
