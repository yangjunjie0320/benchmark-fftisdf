...
#SBATCH --job-name=run-scf-gamma/nio-prim/fftdf/280
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-scf-gamma.py /central/home/junjiey/work/benchmark-fftisdf/work/run-scf-gamma/nio-prim/fftdf/280/main.py
python main.py --name=nio-prim --ke_cutoff=280.0 --exxdiv=None --df=fftdf --chk_path=/central/scratch/yangjunjie//run-scf-gamma/nio-prim/gdf/47958840/scf.h5
