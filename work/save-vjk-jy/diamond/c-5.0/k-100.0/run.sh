...
#SBATCH --job-name=save-vjk-jy/diamond/c-5.0/k-100.0
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/save-vjk-jy.py /central/home/junjiey/work/benchmark-fftisdf/work/save-vjk-jy/diamond/c-5.0/k-100.0/main.py
python main.py --name diamond --c0=5.0 --k0=100.0 --ke_cutoff=70.0 --exxdiv=None 
