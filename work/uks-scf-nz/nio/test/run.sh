...
#SBATCH --job-name=uks-scf-nz/nio/test
...
cp /home/junjiey/work/benchmark-fftisdf/src/script/uks-scf-nz.py main.py
python main.py --name=nio --c0=10.0 --rela_qr=0.001 --aoR_cutoff=1e-06 --ke_cutoff=200.0 --df=gdf
