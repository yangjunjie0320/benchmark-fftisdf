...
#SBATCH --job-name=check-init-energy-nz/hg1212/c0-20.0-qr-1.00e-04-aoR-1.00e-06/
...
python main.py --name hg1212 --c0=20.0 --rela_qr=0.0001 --aoR_cutoff=1e-06 --kmesh=1-1-1 --ke_cutoff=40.0
