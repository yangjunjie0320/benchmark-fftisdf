...
#SBATCH --job-name=check-init-energy-nz/hg1212/c0-30.0-qr-1.00e-03-aoR-1.00e-10/
...
python main.py --name hg1212 --c0=30.0 --rela_qr=0.001 --aoR_cutoff=1e-10 --kmesh=1-1-1 --ke_cutoff=40.0
