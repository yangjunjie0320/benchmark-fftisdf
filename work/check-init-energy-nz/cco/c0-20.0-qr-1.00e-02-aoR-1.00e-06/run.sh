...
#SBATCH --job-name=check-init-energy-nz/cco/c0-20.0-qr-1.00e-02-aoR-1.00e-06/
...
python main.py --name cco --c0=20.0 --rela_qr=0.01 --aoR_cutoff=1e-06 --kmesh=1-1-1 --ke_cutoff=40.0
