...
#SBATCH --job-name=check-init-energy-nz/cco/c0-30.0-qr-1.00e-02-aoR-1.00e-10/
...
python main.py --name cco --c0=30.0 --rela_qr=0.01 --aoR_cutoff=1e-10 --kmesh=1-1-1 --ke_cutoff=40.0
