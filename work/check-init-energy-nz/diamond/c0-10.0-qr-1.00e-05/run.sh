...
#SBATCH --job-name=check-init-energy-nz/diamond/c0-10.0-qr-1.00e-05/
...
python main.py --name diamond --c0=10.0 --rela_qr=1e-05 --aoR_cutoff=1e-6 --kmesh=1-1-1 --ke_cutoff=40.0
