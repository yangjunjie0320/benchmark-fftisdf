...
#SBATCH --job-name=check-init-energy-nz/nio/c0-10.0-qr-1.00e-02-aoR-1.00e-08/
...
python main.py --name nio --c0=10.0 --rela_qr=0.01 --aoR_cutoff=1e-08 --kmesh=1-1-1 --ke_cutoff=40.0
