...
#SBATCH --job-name=check-init-energy-nz/nio/c0-40.0-qr-1.00e-05-aoR-1.00e-06/
...
python main.py --name nio --c0=40.0 --rela_qr=1e-05 --aoR_cutoff=1e-06 --kmesh=1-1-1 --ke_cutoff=40.0
