...
python main.py --name=diamond-prim --ke_cutoff=100.0 --exxdiv=None --df=fftisdf-ks --chk_path=../../../gdf-32/tmp/scf.h5 --mesh=4,4,4 --rcut_epsilon=1e-05 --ke_epsilon=0.01 --isdf_thresh=5e-05
