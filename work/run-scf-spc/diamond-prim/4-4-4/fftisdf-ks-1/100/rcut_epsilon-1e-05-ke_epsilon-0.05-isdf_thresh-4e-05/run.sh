...
#SBATCH --job-name=run-scf-spc-diamond-prim-4-4-4-fftisdf-ks-1-100-rcut_epsilon-1e-05-ke_epsilon-0.05-isdf_thresh-4e-05
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-scf-spc.py /central/home/junjiey/work/benchmark-fftisdf/work/run-scf-spc/diamond-prim/4-4-4/fftisdf-ks-1/100/rcut_epsilon-1e-05-ke_epsilon-0.05-isdf_thresh-4e-05/main.py
python main.py --name=diamond-prim --ke_cutoff=100.0 --exxdiv=None --df=fftisdf-ks --chk_path=../../../gdf-32/tmp/scf.h5 --mesh=4,4,4 --rcut_epsilon=1e-05 --ke_epsilon=0.05 --isdf_thresh=4e-05
