...
#SBATCH --job-name=run-scf-spc-diamond-prim-2-2-2-gdf-32-
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-scf-spc.py /central/home/junjiey/work/benchmark-fftisdf/work/run-scf-spc/diamond-prim/2-2-2/gdf-32//main.py
python main.py --name=diamond-prim --ke_cutoff=None --exxdiv=None --df=gdf --chk_path=None --mesh=2,2,2
