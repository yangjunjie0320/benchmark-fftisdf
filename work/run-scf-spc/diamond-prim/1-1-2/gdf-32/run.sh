...
#SBATCH --job-name=run-scf-spc-diamond-prim-1-1-2-gdf-32-
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-scf-spc.py /central/home/junjiey/work/benchmark-fftisdf/work/run-scf-spc/diamond-prim/1-1-2/gdf-32//main.py
