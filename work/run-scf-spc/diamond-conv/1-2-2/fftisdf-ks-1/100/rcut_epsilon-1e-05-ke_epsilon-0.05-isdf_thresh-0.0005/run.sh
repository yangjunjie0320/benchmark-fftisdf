...
python main.py --name=diamond-conv --ke_cutoff=100.0 --exxdiv=None --df=fftisdf-ks --chk_path=../../../gdf-64/tmp/scf.h5 --mesh=1,2,2 --rcut_epsilon=1e-05 --ke_epsilon=0.05 --isdf_thresh=0.0005
