...
#SBATCH --job-name=run-scf-spc-diamond-conv-1-1-2-fftdf-occri-1-100-
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-scf-spc.py /central/home/junjiey/work/benchmark-fftisdf/work/run-scf-spc/diamond-conv/1-1-2/fftdf-occri-1/100//main.py
python main.py --name=diamond-conv --ke_cutoff=100.0 --exxdiv=None --df=fftdf-occri --chk_path=../../gdf-64/tmp/scf.h5 --mesh=1,1,2
