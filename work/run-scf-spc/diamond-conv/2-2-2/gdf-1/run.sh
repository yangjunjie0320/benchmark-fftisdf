...
#SBATCH --job-name=run-scf-spc-diamond-conv-2-2-2-gdf-1-
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-scf-spc.py /central/home/junjiey/work/benchmark-fftisdf/work/run-scf-spc/diamond-conv/2-2-2/gdf-1//main.py
