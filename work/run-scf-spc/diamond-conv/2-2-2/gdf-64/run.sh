...
#SBATCH --job-name=run-scf-spc-diamond-conv-2-2-2-gdf-64-
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-scf-spc.py /central/home/junjiey/work/benchmark-fftisdf/work/run-scf-spc/diamond-conv/2-2-2/gdf-64//main.py
python main.py --name=diamond-conv --ke_cutoff=None --exxdiv=None --df=gdf --chk_path=None --mesh=2,2,2
