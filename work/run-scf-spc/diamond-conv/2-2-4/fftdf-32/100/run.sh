...
#SBATCH --job-name=run-scf-spc-diamond-conv-2-2-4-fftdf-32-100-
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/run-scf-spc.py /central/home/junjiey/work/benchmark-fftisdf/work/run-scf-spc/diamond-conv/2-2-4/fftdf-32/100//main.py
python main.py --name=diamond-conv --ke_cutoff=100.0 --exxdiv=None --df=fftdf --chk_path=None --mesh=2,2,4
