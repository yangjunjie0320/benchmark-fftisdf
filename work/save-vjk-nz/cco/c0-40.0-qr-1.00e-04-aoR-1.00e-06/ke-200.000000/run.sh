...
#SBATCH --job-name=save-vjk-nz/cco/c0-40.0-qr-1.00e-04-aoR-1.00e-06/ke-200.000000/
...
python main.py --name cco --c0=40.0 --rela_qr=0.0001 --aoR_cutoff=1e-06 --ke_cutoff=200.0
