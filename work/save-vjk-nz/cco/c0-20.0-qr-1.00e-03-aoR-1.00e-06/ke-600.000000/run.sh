...
#SBATCH --job-name=save-vjk-nz/cco/c0-20.0-qr-1.00e-03-aoR-1.00e-06/ke-600.000000/
...
python main.py --name cco --c0=20.0 --rela_qr=0.001 --aoR_cutoff=1e-06 --ke_cutoff=600.0
