...
#SBATCH --job-name=save-vjk-nz/cco/c0-10.0-qr-1.00e-05-aoR-1.00e-06/ke-1000.000000/
...
python main.py --name cco --c0=10.0 --rela_qr=1e-05 --aoR_cutoff=1e-06 --ke_cutoff=1000.0
