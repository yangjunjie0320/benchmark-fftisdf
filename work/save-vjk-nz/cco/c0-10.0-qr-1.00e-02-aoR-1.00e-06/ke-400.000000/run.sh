...
#SBATCH --job-name=save-vjk-nz/cco/c0-10.0-qr-1.00e-02-aoR-1.00e-06/ke-400.000000/
...
python main.py --name cco --c0=10.0 --rela_qr=0.01 --aoR_cutoff=1e-06 --ke_cutoff=400.0
