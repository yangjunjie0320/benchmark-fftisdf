...
#SBATCH --job-name=save-vjk-nz/diamond/c0-10.0-qr-1.00e-04-aoR-1.00e-06/ke-400.000000/
...
python main.py --name diamond --c0=10.0 --rela_qr=0.0001 --aoR_cutoff=1e-06 --ke_cutoff=400.0
