...
#SBATCH --job-name=save-vjk-nz/diamond/c0-20.0-qr-1.00e-02-aoR-1.00e-06/ke-160.000000/
...
python main.py --name diamond --c0=20.0 --rela_qr=0.01 --aoR_cutoff=1e-06 --ke_cutoff=160.0
