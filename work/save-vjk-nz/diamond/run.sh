...
#SBATCH --job-name=save-vjk-nz/diamond/
...
cp /central/home/junjiey/work/benchmark-fftisdf/src/script/save-vjk-nz.py /central/home/junjiey/work/benchmark-fftisdf/work/save-vjk-nz/diamond//main.py
python main.py --name diamond --c0=25.0 --rela_qr=1e-05 --aoR_cutoff=1e-07 --ke_cutoff=70.0 --exxdiv=None 
