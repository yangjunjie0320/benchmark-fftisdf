...
#SBATCH --job-name=save-vjk-nz/diamond/c0-15.0-qr-1.00e-04-aoR-1.00e-06/ke-120.000000/
...
python main.py --name diamond --c0=15.0 --rela_qr=0.0001 --aoR_cutoff=1e-06 --ke_cutoff=120.0
