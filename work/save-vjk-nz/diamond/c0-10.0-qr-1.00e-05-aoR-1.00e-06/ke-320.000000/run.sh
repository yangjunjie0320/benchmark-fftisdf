...
#SBATCH --job-name=save-vjk-nz/diamond/c0-10.0-qr-1.00e-05-aoR-1.00e-06/ke-320.000000/
...
python main.py --name diamond --c0=10.0 --rela_qr=1e-05 --aoR_cutoff=1e-06 --ke_cutoff=320.0
