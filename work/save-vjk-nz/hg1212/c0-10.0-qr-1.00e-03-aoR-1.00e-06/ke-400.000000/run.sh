...
#SBATCH --job-name=save-vjk-nz/hg1212/c0-10.0-qr-1.00e-03-aoR-1.00e-06/ke-400.000000/
...
python main.py --name hg1212 --c0=10.0 --rela_qr=0.001 --aoR_cutoff=1e-06 --ke_cutoff=400.0
