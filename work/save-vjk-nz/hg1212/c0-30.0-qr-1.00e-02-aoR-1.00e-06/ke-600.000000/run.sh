...
#SBATCH --job-name=save-vjk-nz/hg1212/c0-30.0-qr-1.00e-02-aoR-1.00e-06/ke-600.000000/
...
python main.py --name hg1212 --c0=30.0 --rela_qr=0.01 --aoR_cutoff=1e-06 --ke_cutoff=600.0
