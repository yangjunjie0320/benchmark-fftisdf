...
#SBATCH --job-name=save-vjk-nz/nio/c0-20.0-qr-1.00e-02-aoR-1.00e-06/ke-80.000000/
...
python main.py --name nio --c0=20.0 --rela_qr=0.01 --aoR_cutoff=1e-06 --ke_cutoff=80.0
