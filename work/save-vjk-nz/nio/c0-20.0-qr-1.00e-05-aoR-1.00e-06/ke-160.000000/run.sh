...
#SBATCH --job-name=save-vjk-nz/nio/c0-20.0-qr-1.00e-05-aoR-1.00e-06/ke-160.000000/
...
python main.py --name nio --c0=20.0 --rela_qr=1e-05 --aoR_cutoff=1e-06 --ke_cutoff=160.0
