...
#SBATCH --job-name=save-vjk-nz/nio/c0-25.0-qr-1.00e-04-aoR-1.00e-06/ke-320.000000/
...
python main.py --name nio --c0=25.0 --rela_qr=0.0001 --aoR_cutoff=1e-06 --ke_cutoff=320.0
